...
class recruiterPostCreateView(LoginRequiredMixin, CreateView):
    model = recruiter
    fields = ['name', 'designation', 'starts', 'ends', 'company', 'project_title', 'image', 'industry', 'role_type',
              'gender', 'age_min', 'age_max', 'payment_status', 'location', 'job_title', 'job_details', 'job_exp',
              'skill', 'audition_type', 'contact','email']
