...
import os
ephe_path = os.path.join(os.path.dirname(__file__), 'swiss_ephemeris')
...
#    'astrology',
    ...
    'django_ckeditor_5',
 #   'bootstrap5', 
    'rest_framework' # Correct Bootstrap module
]
...
CKEDITOR_5_CONFIGS = {
    'default': {'toolbar': ['heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', '|', 'blockQuote', 'insertTable', 'undo', 'redo'], 'height': 320},
}
